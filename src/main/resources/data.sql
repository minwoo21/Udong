...
INSERT INTO BOARD (CATEGORY, TIME, TITLE, CONTENT, ID, RECOMMEND) VALUES ('notice', NOW(), '동아리 개설 관련 공지', '동아리는 누구나 창설할 수 있지만 도덕적 사회적 풍기문란을 야기시 예고치 않고 삭제될 수 있습니다.', '운영자', 0);
INSERT INTO BOARD (CATEGORY, TIME, TITLE, CONTENT, ID, RECOMMEND) VALUES ('notice', NOW(), '불법 매크로 유저 제재 관련 공지', '봇을 이용한 다중 가입 및 동일 아이피 다중 아이디 사용 제재 ID: pjm** sdfksjfi32**', '운영자', 0);
INSERT INTO BOARD (CATEGORY, TIME, TITLE, CONTENT, ID, RECOMMEND) VALUES ('notice', NOW(), '운영자에 대한 인격모독 맹목적 비난은 법적 처벌을 받을 수 있습니다.', '운영자도 사람입니다.', '운영자', 0);
