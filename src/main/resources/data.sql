...
INSERT INTO BOARD (CATEGORY, TIME, TITLE, CONTENT, ID, RECOMMEND) VALUES ('free', NOW(), '영자 일 안함?', 'CONTENT 01', '비판적인', 0);
INSERT INTO BOARD (CATEGORY, TIME, TITLE, CONTENT, ID, RECOMMEND) VALUES ('free', NOW(), '우동이 망할 수 밖에 없는 이유.txt', 'CONTENT 02', '방구석전문가', 0);
INSERT INTO BOARD (CATEGORY, TIME, TITLE, CONTENT, ID, RECOMMEND) VALUES ('free', NOW(), '182cm 평범남 vs 162cm 임시완', 'CONTENT 03', '어그로꾼', 0);
